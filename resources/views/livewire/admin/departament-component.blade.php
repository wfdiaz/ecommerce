            ...
            <table class="text-gray-600">
                ...
                <tbody class="divide-y divide-gray-300">
                    @foreach ($departments as $department)
                        <tr>
                            <td class="py-2">
                                <a href="{{route('admin.departaments.show', $department)}}" class="uppercase underline hover:text-blue-600">
                                    {{$department->name}}
                                </a>
                            </td>
                            <td class="py-2">
            ...
            Livewire.on('deleteDepartment', departmentId => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.departament-component', 'delete', departmentId)
