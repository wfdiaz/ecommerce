<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="flex justify-end items-center mt-4">
                ...
                <x-jet-button wire:loading.attr="disabled" wire:target="save" wire:click="save"> Actualizar producto </x-jet-button>
            </div>
        </div>
    ...
    @push('script')
        <script>
            ...
            Livewire.on('deleteColorSize', pivote => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You won't be able to revert this!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.color-size', 'deletepiv', pivote);
