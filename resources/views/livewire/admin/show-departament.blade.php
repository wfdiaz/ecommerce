<div>
    ...
    <div class="containerprop py-12">
        ...
        <x-jet-action-section>
            <x-slot name="title">
                Lista de ciudades / municipios
            </x-slot>
    
            <x-slot name="description">
                Aquí encontrará todas las ciudades / municipios agregados
            </x-slot>
            ...
            Livewire.on('deleteCity', cityId => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.show-departament', 'delete', cityId)
