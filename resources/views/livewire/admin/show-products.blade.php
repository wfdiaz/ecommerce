<div>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <x-button-enlace class="ml-auto bg-pantone-393 hover:bg-pantone-1245 active:bg-pantone-1245 focus:border-pantone-1245 focus:ring-pantone-393" href="{{route('admin.products.create')}}">
                Agregar producto
            </x-button-enlace>
        </div>
    </x-slot>
